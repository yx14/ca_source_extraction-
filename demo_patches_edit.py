...
#%%
#times lists the run time of patch processing, spatial updating, temporal updating, and total time 
times = []
t0 = time.time()
...
print S_or.shape
import h5py as h5
fd = h5.File('dataforV.h5','w')
fd.create_dataset('spatial',data=A_or)
fd.create_dataset('temporal',data=C_or)
fd.create_dataset('deconvolved',data=S_or)
del fd
