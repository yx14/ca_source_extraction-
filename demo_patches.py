...
os.chdir('/home/clusteradmin/caNMF_test')
#% select all tiff files in current folder
fnames=[]
base_folder = '/export/data/160607_KS166_2P_KS/run03_ori12_V1'
#base_folder = 'movies'
#base_folder = '140808_KS092_2P_KSn'
...
fname_new=cse.utilities.save_memmap(fnames,base_name='Yr',resize_fact=(1,1,fraction_downsample),rect = [100, 100, 300, 300])
...
options_patch = cse.utilities.CNMFSetParms(Y,n_processes,p=0,gSig=gSig,K=K,ssub=1,tsub=8,thr=merge_thresh)
...
A2, C2, S2, f2, YrA = cse.utilities.temporal_merge(Yr, A2, b2, C2, f2, YrA, **options['temporal_params'])
#%%
reload(cse.utilities)
#%% Order components
